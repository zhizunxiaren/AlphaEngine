...
| Outcomes | `10-Outcomes/` | 项目路线、MVP 合同、版本成果 | 回答“现在做什么”，一个结论一个 owner |
...
4. **Decide（决策）**：跨 Module、长期有效或存在明显取舍的选择写为 Decision，并链接受影响成果。
...
- MVP 1 Module、Interface、技术与验收 → [[10-Outcomes/20-MVP1]]
- MVP 2 现代能力与跨后端策略 → [[10-Outcomes/30-MVP2]]
